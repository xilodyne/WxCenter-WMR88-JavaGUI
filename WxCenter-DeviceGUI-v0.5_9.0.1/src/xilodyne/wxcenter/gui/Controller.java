...
//import xilodyne.wxcenter.devices.WXAnemometer;
...
public class Controller {
	...
	public Controller(final Model model, final View view) {
		...
		this.setDateHoldIndoorTemp(WxLogging.getTimeStamp());
		this.setDateHoldOutdoorHumidity(WxLogging.getTimeStamp());
	...
	public Date getDateHoldIndoorTemp() {
		return dateHoldIndoorTemp;
	}

	public void setDateHoldIndoorTemp(Date dateHoldIndoorTemp) {
		this.dateHoldIndoorTemp = dateHoldIndoorTemp;
	}

	public Date getDateHoldOutdoorHumidity() {
		return dateHoldOutdoorHumidity;
	}

	public void setDateHoldOutdoorHumidity(Date dateHoldOutdoorHumidity) {
		this.dateHoldOutdoorHumidity = dateHoldOutdoorHumidity;
	}
}
