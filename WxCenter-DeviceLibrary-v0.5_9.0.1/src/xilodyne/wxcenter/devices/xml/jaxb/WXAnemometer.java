...
@XmlRootElement
public class WXAnemometer extends WXCenterDevice {
	...
	public WXAnemometer(String message) {
		super(message);
		this.setValues();
	...
	public void loadWind(WXAnemometer temp) {
		this.clearValues();
	 ...
	 * iDirCode = (int) directionCode; return ( // return wind direction descr.
