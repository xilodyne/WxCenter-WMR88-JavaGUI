...
@XmlRootElement
public class WXThermohygrometer extends WXCenterDevice {
	...
	public WXThermohygrometer(){
		super();
	}
	
	public WXThermohygrometer(String message) {
		super(message);
		this.setValues();
	...
	public void loadTemp(WXThermohygrometer temp) {
		this.clearValues();
