...
@Root
public class WXBarometerSimpleXML extends WXCenterDeviceSimpleXML {

	@Element(name = "barABS")
	private int pressureAbsolute;
	private int pressureRelative;
	
	@Element(name = "weatherForecastValue")
	private int weatherForecastValue;
	private String weatherForecast;
	private String weatherPrevious;
	
	public WXBarometerSimpleXML() {
		super();
			}

	//new creation from application
	public WXBarometerSimpleXML(String message) {
		super(message);
		this.setValues();
	...
	//load from JAXB
	public void loadBarm(WXBarometerSimpleXML temp) {
		this.clearValues();
