...
@Root
public class WXCenterDeviceSimpleXML {

	private short[] frame;
	private short device;
	private String message;
	
	@Element(name = "batteryDescription", required = false)
	private String batteryDescription;
	
	@Element(name = "batteryValue")
...
//	private String dateTimeStamp;
	...
	public WXCenterDeviceSimpleXML(short[] frame) {
		this.frame = frame;
	}

	public WXCenterDeviceSimpleXML() {
		this.clearValues();
	}
	...
	public WXCenterDeviceSimpleXML(String message) {
