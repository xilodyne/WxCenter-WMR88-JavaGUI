...
@Root
public class WXRainGaugeSimpleXML extends WXCenterDeviceSimpleXML {

	@Element(name = "rainRate")
	private float rainRate;
	
	@Element(name = "rainRecent")
	private float rainRecent;
	
	@Element(name = "rainDay")
	private float rainDay;
	
	@Element(name = "rainReset")
	private float rainReset;

	// private float rainMidnight;

	public WXRainGaugeSimpleXML() {
		super();
	}

	// new creation from application
	public WXRainGaugeSimpleXML(String message) {
		super(message);
		this.setValues();
	...
	// load from JAXB
	public void loadRain(WXRainGaugeSimpleXML temp) {
		this.clearValues();
